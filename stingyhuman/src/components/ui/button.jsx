...
const Button = React.forwardRef(({ className, variant, size, asChild = false, onClick, id, ...props }, ref) => {
  const Comp = asChild ? Slot : 'button';

  return <Comp onClick={onClick} id={id} className={cn(buttonVariants({ variant, size, className }))} ref={ref} {...props} />;
});
